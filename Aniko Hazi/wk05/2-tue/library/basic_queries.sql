...
VALUES ('Aniko Hazi', 'Hungary', 1979);

-- Add two books that you'd like to write (you can hard-code your id as the author id)

INSERT INTO books(title, publication_date, author_id)
VALUES ('The Return of Sharknado', 2018, 9);

INSERT INTO books(title, publication_date, author_id)
VALUES ('Ghost Shark: the Revenge of Sharknado', 2023, 9);

-- Update one of your books to have a new title

UPDATE books
SET title = 'Sharknado IV'
WHERE author_id = 9 AND publication_date = 2018;
